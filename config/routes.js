...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  '/bugversion/:version' : { controller: 'js/ticket', action: 'bugversion' },
  ...
  '/commitlist' : { controller: 'js/commit', action: 'commitlist' },
  '/commitupdate' : { controller: 'js/commit', action: 'updateall' },
  ...
  '/registcommit'   : { controller: 'js/ticket', action: 'registcommit' },
  ...
  '/version' : { controller: 'js/master', action: 'version' },
